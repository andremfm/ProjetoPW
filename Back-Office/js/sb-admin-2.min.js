        ...
        <div class="modal-content">
            <div class="modal-header">
              ...
              <div class="modal-body">
                ...
                <p>SubTotal: (${parseFloat(operacao.TaxaServico) + parseFloat(operacao.TaxaRisco) + parseFloat(operacao.taxaFunc) + parseFloat(operacao.taxaMat)}€)</p>
                ...
                <p>Total: (${(parseFloat(operacao.TaxaServico) + parseFloat(operacao.TaxaRisco) + parseFloat(operacao.taxaFunc) + parseFloat(operacao.taxaMat))*1.23}€)</p>
                </div>
          </div>
      </div>
    </div>
