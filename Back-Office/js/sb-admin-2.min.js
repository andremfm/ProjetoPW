...
function loadData() {
    ...
    let tableData = data.map(funcionario => (
      ...
      <tr>
        ...
        <td class="btn btn-info btn-sm" data-toggle="modal" data-target="#func-modal">Alterar</td>
        <td class="btn btn-danger btn-sm delete" onclick="delFunc(${i++})">Apagar</td>
      </tr>
      <div class="modal fade" id="func-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <a class="btn btn-info" onclick="guardarFunc() ; window.location.reload()" >Submeter</a>
              </div>
          </div>
      </div>
  </div>
...
function loadOp2(){
  let data = JSON.parse(localStorage.getItem("funcionarios"))
    ...
    let tableData = data.map(funcionario => (
        ...
        `
      <tr>
        <td><input type="checkbox" id="checkFunc" name="funcionario" value="${funcionario.Nome} ${funcionario.Apelido},${funcionario.Valor}"></td>
        <td>${funcionario.Funcao}</td>
        <td>${funcionario.Nome} ${funcionario.Apelido}</td>
        <td>${funcionario.Valor}€</td>
      </tr>
...
function loadOp3(){
  ...
  let tableData = data.map(material => (
      `
    <tr>
      <td><input type="checkbox" id="checkMat" name="material" value="${material.Valor}"></td>
      <td>${material.Tipo}</td>
